...
class Client {
    ...
    public function ajouterReservation(Reservation $reservation): void {
        ...
        // Ajoute la réservation à la liste de réservations
    }
    ...
    public function afficherReservationsClient(): void {
        ...
        if (empty($this->_reservations)) {
            ...
            // Affiche un message si aucune réservation n'est trouvée
        } else {
            ...
            foreach ($this->_reservations as $reservation) {
                echo $reservation . "<br>"; 
                // Affiche chaque réservation en utilisant __toString de la classe Reservation
